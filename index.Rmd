...
1. <font size="4">**Mercado Spot:**</font>
  ...
  + **Knowledge and Technologies:**<br>
    R programming, Machine Learning, Data treatment, Electric market
    <br>
...
Analyze and find the parameters that are more influential in the price of electricity. For later create a model that tries to predict the price.
...
+ **Dia:** a column that says if the day is a holiday or not.<br>
...
<br>
Scatter charts can help us to understand how the price of electricity depends on the different features.
<br>
<br>
...
real<-pv_modelR_test%>%select(datetime,Precio_mercado_SPOT_Diario)%>%mutate(Ti="Real")
prediccion<-pv_modelR_test%>%select(datetime,prediccion)%>%mutate(Ti="Predicted")
...
**Main inconformations:** It contains information about some fundamental parameters for the welding process. This tab is interactive and allows increasing the level of granularity of the data.<br>
...
**Log information:** A record is kept of all the points where the user is able to interact with the application. To have control of possible errors.<br>
<br>
...
<br>
The problem that the program of the video responds to, is the picking up of several people in their locality of residence in the morning and return them at the end of the day. To do this, they have a fleet with different types of vehicles, which should be combined in the best possible way trying to minimize the inverted times or kilometers traveled, etc<br>
<br>
To solve this problem we are going to use Excel, where we are going to code using VBA different algorithms like:
<br>
<br>
• Simple iteratives from random solution:<br>
- SWAP<br>
- 2 Opt<br>
- Reverse mutation<br>

• Random iterations from random solution:<br>
- SWAP<br>
- 2 Opt<br>
- Reverse mutation<br>
<br>
...
Video showing how the application works:
<br>
<iframe width="747" height="420" src="https://www.youtube.com/embed/G6h43vWsuFY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>



## QLIK SENSE coronavirus dashboard {.tabset}


This panel contains three screens that refer to information about COVID-19 worldwide and for Spain.<br>
<br>
The results presented in this panel are obtained from the declaration of COVID-19 cases to the National Network of Epidemiological Surveillance (RENAVE) and the WHO.<br>
<br>
The data collected in different csv files are modified to form the following model:<br>
<br>
![Model:](modelo2.png)
<br><br>
Video showing how the application works:<br>
<br>
<iframe width="747" height="420" src="https://www.youtube.com/embed/hSISJ80UfJQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
